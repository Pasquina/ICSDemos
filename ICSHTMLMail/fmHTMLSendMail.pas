...
begin
  LServerConnection.Create(leServerHostName.Text,       // build the connection parameters record
    leServerPort.Text,
    leServerLoginName.Text,
    leServerLoginPassword.Text);
...
begin
  ...
  sbMain.SimpleText := LAppParameters;                            // display application parameter FQDN
